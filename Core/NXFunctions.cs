...
//       N E V E R S O F T       F U N C T I O N S
//
...
namespace WTDE_Launcher_V3.Core {
    ...
    internal class NXFunctions {
        ...
        /// </summary>
        public static uint[] CRC32_TABLE = new uint[] {
        ...
        public static string MakeQBKeyFromString(string text) {
            ...
            // Turn our string into some text bytes.
            text = text.ToLower().Replace('/', '\\');
            byte[] textBytes = Encoding.UTF8.GetBytes(text);

            Console.WriteLine($"Translating {text} into a QBKey...");

            // We'll pass those text bytes into this function that
            // will actually make our QBKey.
            return MakeQBKeyFromBytes(textBytes);
        }
        ...
        public static string MakeQBKeyFromBytes(byte[] textBytes) {
            ...
            // This is basically standard QBKey generation code...
            // Zedek has made this, Addy has made this, all of us have
            ...
            // Make our final resulting QBKey.
            uint finalCRC = ~crc;
            long value = -finalCRC - 1;
            string result = (value & 0xFFFFFFFF).ToString("X8");

            // Pad string with zeroes, add 0x to the front of the string.
            result = result.PadLeft(8, '0');
            result = "0x" + result;

            Console.WriteLine($"Interpreted QBKey: {result}");
