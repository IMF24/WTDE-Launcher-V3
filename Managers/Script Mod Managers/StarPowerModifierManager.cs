...
namespace WTDE_Launcher_V3 {
    public partial class StarPowerModifierManager : Form {
        ...
        public void SaveSPColors() {
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Title = "Save Star Power Color Palette";
            sfd.Filter = "WTDE Star Power Palettes|*.descolors";
            ...
            if (sfd.FileName != "") {
                using (StreamWriter sw = new StreamWriter(sfd.FileName, false)) {
                    sw.WriteLine("; ------------------------------");
                    sw.WriteLine(";  Custom SP Gem Colors");
                    sw.WriteLine(";    Auto generated by WTDE Launcher V3");
                    sw.WriteLine("; ------------------------------\n");

                    sw.Write("[StarColors]\n" +
                            $"Star_Red={StarColor.BackColor.R}\n" +
                            $"Star_Green={StarColor.BackColor.G}\n" +
                            $"Star_Blue={StarColor.BackColor.B}\n" +
                            $"Star_Alpha={StarColorAlpha.Value}\n" +
                            $"KickStar_Red={KickStarColor.BackColor.R}\n" +
                            $"KickStar_Green={KickStarColor.BackColor.G}\n" +
                            $"KickStar_Blue={KickStarColor.BackColor.B}\n" +
                            $"KickStar_Alpha={KickStarColorAlpha.Value}\n" +
                            $"BaseStar_Red={BaseStarColor.BackColor.R}\n" +
                            $"BaseStar_Green={BaseStarColor.BackColor.G}\n" +
                            $"BaseStar_Blue={BaseStarColor.BackColor.B}\n" +
                            $"BaseStar_Alpha={BaseStarColorAlpha.Value}\n" +
                            $"BaseKickStar_Red={BaseKickStarColor.BackColor.R}\n" +
                            $"BaseKickStar_Green={BaseKickStarColor.BackColor.G}\n" +
                            $"BaseKickStar_Blue={BaseKickStarColor.BackColor.B}\n" +
                            $"BaseKickStar_Alpha={BaseKickStarColorAlpha.Value}\n\n" +
